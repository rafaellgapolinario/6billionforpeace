...
export function HeroHeart() {
  ...
  return (
    <section id="top" className="relative isolate overflow-hidden text-white" dir="ltr">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center justify-center px-6 py-14 text-center sm:py-20">
        <div className="relative aspect-square w-[min(88vw,520px)]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg
              ...
              className="heart-pulse w-[40%] text-white drop-shadow-[0_8px_24px_rgba(0,0,0,0.18)]"
              fill="currentColor"
            >
