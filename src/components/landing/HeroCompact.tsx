...
export function HeroCompact() {
  return (
    <section className="relative isolate overflow-hidden text-white" dir="ltr">
      ...
      />
      <div className="relative mx-auto flex max-w-5xl items-center justify-center px-6 py-10 sm:py-12">
        <div className="relative aspect-square w-[min(72vw,360px)]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg
              ...
              className="heart-pulse w-[40%] text-white drop-shadow-[0_8px_20px_rgba(0,0,0,0.18)]"
              fill="currentColor"
            >
