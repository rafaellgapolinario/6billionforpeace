 ...
 * Logo + coração pulsando com palavras de paz ao redor.
 * LanguagePicker fica só no Header (não duplicar).
 */
const PEACE_WORDS = [
  { word: 'Shlama',  pos: { left: '50%', top: '18%' } },
  { word: 'Мир',     pos: { left: '24%', top: '32%' } },
  { word: 'Peace',   pos: { left: '76%', top: '32%' } },
  { word: 'Frieden', pos: { left: '20%', top: '50%' } },
  { word: 'Paz',     pos: { left: '80%', top: '50%' } },
  { word: 'Pace',    pos: { left: '32%', top: '68%' } },
  { word: 'שלום',    pos: { left: '68%', top: '68%' } },
  { word: 'سلام',    pos: { left: '50%', top: '82%' } },
  { word: '和平',     pos: { left: '50%', top: '50%' } },
] as const;
