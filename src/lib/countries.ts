 ...
 * Labels are resolved at runtime via Intl.DisplayNames (built-in, all locales).
 */
...
export const countryCodes: readonly string[] = [
  ...
  'GG','GN','GW','GY','HT','HM','VA','HN','HK','HU','IS','IN','ID','IR','IQ',
  'IE','IM','IL','IT','JM','JP','JE','JO','KZ','KE','KI','KP','KR','KW','KG',
  'LA','LV','LB','LS','LR','LY','LI','LT','LU','MO','MG','MW','MY','MV','ML',
  'MT','MH','MQ','MR','MU','YT','MX','FM','MD','MC','MN','ME','MS','MA','MZ',
  'MM','NA','NR','NP','NL','NC','NZ','NI','NE','NG','NU','NF','MK','MP','NO',
...
export function getCountryLabel(code: string, locale: string = 'en'): string {
  try {
...
/** Sorted list of {code, label} for a given locale, alpha by label. */
export function listCountries(locale: string = 'en') {
  return [...countryCodes]
